...
public final class DoubleSetDomain implements IDoubleDomain {
  ...
  public static DoubleSetDomain getDomain() {
    if (domain == null) domain = new DoubleSetDomain();
    return domain;
  }
  ...
  public static DoubleDomainOp op() {
    if (OP_INSTANCE == null) OP_INSTANCE = new DoubleDomainOp();
    return OP_INSTANCE;
  }
  ...
  static class DoubleDomainOp implements IDomainOp<Double, Set<Double>> {
    ...
    public IDoubleValue alpha(Set<Double> cvs) {
      // TODO Auto-generated method stub
      if (cvs.size() > MAX_SET_SIZE) return DoubleTopValue.getInstance();
      else return new DoubleSetValue(cvs);
    }
  ...
  public static class DoubleSetValue implements IDoubleValue {
    ...
    public IValue weakUpdate(IValue v) {
      ...
      if (v instanceof BotValue) return this;
        ...
        if (v instanceof DoubleBotValue) return this;
        else if (v instanceof DoubleTopValue) return v;
        else {
          DoubleSetValue ssv = (DoubleSetValue) v;
          ...
          if (newValues.size() > MAX_SET_SIZE) return DoubleTopValue.getInstance();
