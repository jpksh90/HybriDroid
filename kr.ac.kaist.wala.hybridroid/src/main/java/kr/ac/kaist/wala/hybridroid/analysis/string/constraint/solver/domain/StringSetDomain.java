...
public final class StringSetDomain implements IStringDomain {
  ...
  public static StringSetDomain getDomain() {
    if (domain == null) domain = new StringSetDomain();
    return domain;
  }
  ...
  public static StringDomainOp op() {
    if (OP_INSTANCE == null) OP_INSTANCE = new StringDomainOp();
    return OP_INSTANCE;
  }
  ...
  public static class StringDomainOp implements IDomainOp<String, Set<String>> {
    ...
    public IStringValue alpha(Set<String> cvs) {
      if (cvs.size() > MAX_SET_SIZE) return StringTopValue.getInstance();
      else return new StringSetValue(cvs);
    }
  ...
  public static class StringSetValue implements IStringValue {
    ...
    public IValue weakUpdate(IValue v) {
      ...
      if (v instanceof BotValue) return this;
        ...
        if (v instanceof StringBotValue) return this;
        else if (v instanceof StringTopValue) return v;
        else {
          StringSetValue ssv = (StringSetValue) v;
          Set<String> newValues = new HashSet<String>();
          newValues.addAll(values);
          newValues.addAll(ssv.values);
          if (MAX_SET_SIZE < newValues.size()) return StringTopValue.getInstance();
