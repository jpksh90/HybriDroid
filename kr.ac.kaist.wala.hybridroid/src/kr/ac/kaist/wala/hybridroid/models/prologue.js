...
Math = {
    ...
    abs: function Math_abs(x) {
        return (x < 0) ? -x : x;
    },

    acos: function Math_acos(x) {
        return primitive("MathACos", x);
    },

    asin: function Math_asin(x) {
        return primitive("MathASin", x);
    },

    atan: function Math_atan(x) {
        return primitive("MathATan", x);
    },

    atan2: function Math_atan2(y, x) {
        return primitive("MathATan2", y, x);
    },

    ceil: function Math_ceil(x) {
        return primitive("MathCeil", x);
    },

    cos: function Math_cos(x) {
        return primitive("MathCos", x);
    },

    exp: function Math_exp(x) {
        return primitive("MathExp", x);
    },

    floor: function Math_floor(x) {
        return primitive("MathFloor", x);
    },

    log: function Math_log(x) {
        return primitive("MathLog", x);
    },
    ...
    pow: function Math_pow(x, y) {
        return primitive("MathPow", x, y);
    },

    random: function Math_random() {
        return primitive("MathRandom");
    },

    round: function Math_round(x) {
        return primitive("MathRound", x);
    },

    sin: function Math_sin(x) {
        return primitive("MathSin", x);
    },

    sqrt: function Math_sqrt(x) {
        return primitive("MathSqrt", x);
    },

    tan: function Math_tan(x) {
        return primitive("MathTan", x);
    }
};
