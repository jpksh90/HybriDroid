...
/**
 * Build Control-flow graph for the target Android hybrid application. Now, it supports
 * 'addJavascriptInterface' API only to deal with communication between Android Java and JavaScript.
 * This analysis has two step. 1) Pre string analysis for some string value. This phase is needed to
 * get argument values for 'loadUrl' and 'addJavascriptInterface'. 2) Build Control-flow graph. Now,
 * the string analysis can deal with constant values only. We must improve this analysis for
 * accurate Control-flow graph. We analyzed the communication behaviors between Android Java and
 * JavaScript in Android_5.0.2_r3 for this implementation.
 *
 * @author Sungho Lee
 */
public class HybridCFGAnalysis {
   ...
   * @param cha
   */
  public static void addHybridDispatchLogic(
      AnalysisOptions options, AnalysisScope scope, IClassHierarchy cha) {
  ...
  private AndroidStringAnalysis analyzeString(
      String libPath, String targetPath, AndroidResourceAnalysis ara)
    ...
    hotspots.add(
        new ArgumentHotspot(
            ...
            0));
    //		hotspots.add(new ArgumentHotspot(ClassLoaderReference.Application, "android/webkit/WebView",
    // "loadData(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", 0));
    //		hotspots.add(new ArgumentHotspot(ClassLoaderReference.Application, "android/webkit/WebView",
    // "loadDataWithBaseURL(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", 0));
    //		hotspots.add(new ArgumentHotspot(ClassLoaderReference.Application, "android/webkit/WebView",
    // "loadDataWithBaseURL(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", 1));
    //		hotspots.add(new ArgumentHotspot(ClassLoaderReference.Application, "android/webkit/WebView",
    // "loadDataWithBaseURL(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", 2));
    //		hotspots.add(new ArgumentHotspot(ClassLoaderReference.Application, "android/webkit/WebView",
    // "loadDataWithBaseURL(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", 3));
    asa.analyze(hotspots);

    return asa;
  }

  private AndroidHybridAnalysisScope makeScope(
      String libPath, String targetPath, AndroidResourceAnalysis ara, AndroidStringAnalysis asa)
      throws IOException {
    ...
    AnalysisScopeBuilder scopeBuilder =
        AnalysisScopeBuilder.build(dirPath, new File(targetPath), false, jsFiles);
  ...
  private boolean isEqualOrAboveJELLY_BEAN_MR1(YMLData data) {
    ...
    if (name.equals("targetSdkVersion")) {
      ...
      boolean is = true;
      for (YMLData child : data.getChildren()) is &= isEqualOrAboveJELLY_BEAN_MR1(child);
      return is;
    }
  }
   ...
   */
  public Pair<CallGraph, PointerAnalysis<InstanceKey>> main(String targetPath, String libPath)
    ...
    ComposedEntrypoints roots = AndroidHybridAppModel.getEntrypoints(cha, scope, options, cache);
    options.setEntrypoints(roots);
    options.setReflectionOptions(ReflectionOptions.NONE);
    addHybridDispatchLogic(options, scope, cha);

    AndroidHybridCallGraphBuilder b =
        new AndroidHybridCallGraphBuilder(
            Language.JAVA.getFakeRootMethod(cha, options, cache),
            options,
            cache,
            HybridAPIMisusesChecker.getInstance(),
            asa,
            ara,
            annVersion);
  ...
  private void test(
      AndroidHybridCallGraphBuilder b, CallGraph cg, PointerAnalysis<InstanceKey> pa) {
    for (CGNode n : cg) {
      if (n.toString().contains("error_page")) {
        IRPrinter.printIR(
            ...
            "ir-print",
            (node) -> {
              if (node.toString().contains("error_page")) return true;
              return false;
            });
        if (n.toString()
                .contains(
                    "Node: <Code body of function L/var/folders/57/cz70blns3w35yrztpxd3_rv40000gn/T/error_page.htm")
            && n.toString().endsWith(".js/__WINDOW_MAIN__> Context: Everywhere")) {
          ...
          for (SSAInstruction inst : insts) {
            ...
            System.out.println(
                "( "
                    ...
                    + inst
                    + ", "
                    + ((inst == null) ? "" : inst.getClass().getName()));
            if (inst != null
                && inst instanceof AstGlobalRead
                && inst.toString().contains("errorRetriever")) {
