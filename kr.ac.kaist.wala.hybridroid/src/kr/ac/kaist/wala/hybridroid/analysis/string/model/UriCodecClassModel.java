...
public class UriCodecClassModel extends AbstractClassModel {
  ...
  public static UriCodecClassModel getInstance() {
    if (instance == null) instance = new UriCodecClassModel();
    return instance;
  }

  protected void init() {
    methodMap.put(
        Selector.make("decode(Ljava/lang/String;ZLjava/nio/charset/Charset;Z)Ljava/lang/String;"),
        new Decode());
  }
  ...
  class Decode implements IMethodModel<Set<IBox>> {
    ...
    public Set<IBox> draw(
      ...
      if (graph.addEdge(
          new UriCodecDecodeOpNode(), def, stringBox, convertPlusBox, charsetBox, throwBox)) {
