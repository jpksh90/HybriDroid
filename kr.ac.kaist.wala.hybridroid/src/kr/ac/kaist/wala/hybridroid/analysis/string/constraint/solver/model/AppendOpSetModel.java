...
public class AppendOpSetModel implements IOperationModel {
  ...
  public static AppendOpSetModel getInstance() {
    if (instance == null) instance = new AppendOpSetModel();
    return instance;
  }
  ...
  public IValue apply(IValue... args) {
    ...
    if (args.length != 2) throw new InternalError("Append operation must have only two in-edge.");
    ...
    if (absFront instanceof BotValue || absBack instanceof BotValue)
    ...
    else if (absFront instanceof StringSetValue
        && absBack instanceof StringSetValue) { // this part is domain specific!
      ...
      return domain.getOperator().alpha(res);
        ...
        && absBack instanceof IntegerSetValue) { // this part is domain specific!;
      ...
      return StringSetDomain.op().alpha(res);
        ...
        && absBack instanceof DoubleSetValue) { // this part is domain specific!;
      Set<String> front = (Set<String>) absFront.getDomain().getOperator().gamma(absFront);
      ...
      return StringSetDomain.op().alpha(res);
        ...
        && absBack instanceof LongSetValue) { // this part is domain specific!;
      Set<String> front = (Set<String>) absFront.getDomain().getOperator().gamma(absFront);
      ...
      return StringSetDomain.op().alpha(res);
    } else if (absFront instanceof IntegerSetValue
        && absBack instanceof StringSetValue) { // this part is domain specific!;
      ...
      Assertions.UNREACHABLE(
          "incorrect args(arg1: "
              + absFront.getClass().getName()
              + ", arg2: "
              + absBack.getClass().getName()
              + ")");
