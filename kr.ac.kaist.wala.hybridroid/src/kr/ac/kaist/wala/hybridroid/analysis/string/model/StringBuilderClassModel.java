...
public class StringBuilderClassModel extends AbstractClassModel {
  ...
  public static StringBuilderClassModel getInstance() {
    if (instance == null) instance = new StringBuilderClassModel();
    return instance;
  }
  ...
  protected void init() {
    ...
    methodMap.put(
        Selector.make("append(Ljava/lang/String;)Ljava/lang/StringBuilder;"), new Append());
    methodMap.put(
        Selector.make("append(Ljava/lang/Object;)Ljava/lang/StringBuilder;"), new Append());
  ...
  class ToString implements IMethodModel<Set<IBox>> {
    ...
    public Set<IBox> draw(
      ...
      if (graph.addEdge(new ToStringOpNode(), def, use)) boxSet.add(use);
      return boxSet;
    }
  ...
  class Init1 implements IMethodModel<Set<IBox>> {
    ...
    public Set<IBox> draw(
      ...
      if (graph.addEdge(new AssignOpNode(), def, use)) boxSet.add(use);
