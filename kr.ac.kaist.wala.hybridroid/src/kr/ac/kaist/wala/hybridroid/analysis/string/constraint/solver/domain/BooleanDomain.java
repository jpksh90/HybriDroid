...
public final class BooleanDomain implements IBooleanDomain {
  ...
  public static BooleanDomain getDomain() {
    if (domain == null) domain = new BooleanDomain();
    return domain;
  }

  public static BooleanDomainOp op() {
    if (OP_INSTANCE == null) OP_INSTANCE = new BooleanDomainOp();
    return OP_INSTANCE;
  }
  ...
  public static class BooleanDomainOp implements IDomainOp<Boolean, Set<Boolean>> {
    ...
    public IBooleanValue alpha(Set<Boolean> cvs) {
      // TODO Auto-generated method stub
      if (cvs.size() > 1) return BooleanTopValue.getInstance();
      else return new BooleanValue(cvs.iterator().next());
    }
  ...
  public static class BooleanValue implements IBooleanValue {
    ...
    public IValue weakUpdate(IValue v) {
      ...
      if (v instanceof BotValue) return this;
        ...
        if (v instanceof BooleanBotValue) return this;
        else if (v instanceof BooleanTopValue) return v;
        else {
          BooleanValue bv = (BooleanValue) v;
          if (bv.value == value) return this;
          else return BooleanTopValue.getInstance();
        }
    ...
    public boolean equals(Object o) {
      if (o instanceof BooleanValue) {
        ...
        if (b.value == this.value) return true;
      }
      return false;
    }
