...
public class AndroidMethodTargetSelector extends ClassHierarchyMethodTargetSelector {
  ...
  public AndroidMethodTargetSelector(IClassHierarchy cha) {
    ...
    TypeReference threadTR =
        TypeReference.find(ClassLoaderReference.Primordial, "Ljava/lang/Thread");
    TypeReference asyncTaskTR =
        TypeReference.find(ClassLoaderReference.Primordial, "Landroid/os/AsyncTask");
  ...
  public IMethod getCalleeTarget(CGNode caller, CallSiteReference call, IClass receiver) {
    ...
    //		if(receiver != null && ((activityClass.equals(receiver) || cha.isSubclassOf(receiver,
    // activityClass)) ||
