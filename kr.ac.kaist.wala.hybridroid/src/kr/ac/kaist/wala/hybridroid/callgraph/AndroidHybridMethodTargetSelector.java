...
public class AndroidHybridMethodTargetSelector extends CrossLanguageMethodTargetSelector {
  public static boolean DEBUG = false;

  public AndroidHybridMethodTargetSelector(Map<Atom, MethodTargetSelector> languageSelectors) {
