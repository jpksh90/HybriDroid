...
public class XMLManifestReader {
  ...
  public static final String APK_TOOL = "apktool.jar";
  ...
  public static final String ACTIVITY_ALIAS_TAG = "activity_alias";
  public static final String APPLICATION_TAG = "application";
  public static final String CATEGORY_TAG = "category";
  public static final String COMPATIBLE_SCREENS_TAG = "compatible-screens";
  public static final String DATA_TAG = "data";
  public static final String GRANT_URI_PERMISSION_TAG = "grant-uri-permission";
  public static final String INSTRUMENTATION_TAG = "instrumentation";
  ...
  public static final String PATH_PERMISSION_TAG = "path-permission";
  public static final String PERMISSION_TAG = "permission";
  public static final String PERMISSION_GROUP_TAG = "permission-group";
  public static final String PERMISSION_TREE_TAG = "permission-tree";
  public static final String PROVIDER_TAG = "provider";
  public static final String RECEIVER_TAG = "receiver";
  public static final String SERVICE_TAG = "service";
  public static final String SUPPORTS_GL_TEXTURE_TAG = "supports-gl-texture";
  public static final String SUPPORTS_SCREENS_TAG = "supports-screens";
  public static final String USES_CONFIGURATION_TAG = "uses-configuration";
  public static final String USES_FEATURE_TAG = "uses-feature";
  public static final String USES_LIBRARY_TAG = "uses-library";
  public static final String USES_PERMISSION_TAG = "uses-permission";
  public static final String USES_SDK_TAG = "uses-sdk";
  ...
  public XMLManifestReader(String apkFile) {
    ...
    try {
      InputStream xmlFile =
          new FileInputStream(unpackApk(apkFile) + File.separator + MANIFEST_FILE);
      readXML(xmlFile);
  ...
  private String unpackApk(String apkFile) {
    ...
    while (st.hasMoreTokens()) file = st.nextToken();

    System.out.println(
        "APK_TOOL_PATH: " + Shell.walaProperties.getProperty(WalaProperties.ANDROID_APK_TOOL));
    String pathToApkTool =
        Shell.walaProperties.getProperty(WalaProperties.ANDROID_APK_TOOL)
            + File.separator
            + APK_TOOL;
    String pathToJava =
    ...
    ProcessBuilder pb =
        new ProcessBuilder(pathToJava, "-jar", pathToApkTool, "d", apkFile, "-f", "-o", TMP_FOLDER);
    ...
    try {
      ...
      String s;
      while ((s = stdInput.readLine()) != null) Debug.printMsg(s);

      while ((s = stdError.readLine()) != null) Debug.printMsg(s);
    } catch (IOException e) {
  ...
  private class SAXHandler extends DefaultHandler {
    ...
    private Property newProp(int type, Property parent) {
      ...
      if (pProp != null) pProp.addChild(cProp);
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
      ...
      if (!qName.equals(MANIFEST_TAG)) pProp = cProp.getParent();
    }
  }
}
