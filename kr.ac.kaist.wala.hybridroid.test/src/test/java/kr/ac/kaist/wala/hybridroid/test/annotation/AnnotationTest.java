...
public class AnnotationTest {
  ...
  @Test
  public void missingAnnotationMethodShouldInvisible()
      ...
      for (String s : cfgAnalysis.getWarnings()) {
        switch (testName) {
          case "AnnotationTest.apk":
            ...
            assertEquals(
                testName + ": ",
                "[Error] the [[JAVA_JS_BRIDGE:<Application,Lkr/ac/kaist/wala/hybridroid/test/annotation/JSBridge>],<field getLastName>] is not matched.",
                s);
            break;
        }
      }
