...
public class MultipleWebViewTest {
  ...
  @Test
  public void shareOneBridgeByTwoWebView()
    ...
    for (File f : tests) {
      ...
      switch (testName) {
        case "MultipleWebViewTest.apk":
              ...
              cg.getClassHierarchy()
                  .lookupClass(
                      TypeReference.find(
                          ...
                          "Lkr/ac/kaist/wala/hybridroid/test/multiplewebviewtest/JSBridge"));
          ...
          IMethod getLastNameM =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridgeC.getReference(),
                          Selector.make("getLastName()Ljava/lang/String;")));
          IMethod getFirstNameM =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridgeC.getReference(),
                          Selector.make("getFirstName()Ljava/lang/String;")));
          ...
          assertTrue(
              "getName's predecessors must come from two different htmls.", index1 && index2);
          ...
          for (CGNode n : firstPreds) {
            assertTrue(
                "getFirstName method must be called at getName function from index1.html.",
                n.toString().contains("index1.html"));
          }
          ...
          for (CGNode n : lastPreds) {
            assertTrue(
                "getLastName method must be called at getName function from index2.html.",
                n.toString().contains("index2.html"));
          }
      }
    }
  }
        ...
        case "MultipleWebViewAndDiffBridgeTest.apk":
          IClass bridge1C =
              cg.getClassHierarchy()
                  .lookupClass(
                      TypeReference.find(
                          ClassLoaderReference.Application,
                          "Lkr/ac/kaist/wala/hybridroid/test/multiplewebviewanddiffbridgetest/JSBridge1"));
          IClass bridge2C =
              cg.getClassHierarchy()
                  .lookupClass(
                      TypeReference.find(
                          ClassLoaderReference.Application,
                          "Lkr/ac/kaist/wala/hybridroid/test/multiplewebviewanddiffbridgetest/JSBridge2"));

          IMethod getName1M =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridge1C.getReference(), Selector.make("getName()Ljava/lang/String;")));
          IMethod getLastName1M =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridge1C.getReference(),
                          Selector.make("getLastName()Ljava/lang/String;")));
          IMethod getFirstName1M =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridge1C.getReference(),
          ...
          IMethod getName2M =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridge2C.getReference(), Selector.make("getName()Ljava/lang/String;")));
          IMethod getLastName2M =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridge2C.getReference(),
                          Selector.make("getLastName()Ljava/lang/String;")));
          IMethod getFirstName2M =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridge2C.getReference(),
          ...
          assertTrue(
              "getName(of first bridge) method must have two predecessors.",
              name1Preds.size() == 2);
          ...
          assertTrue(
              "getName(of first bridge)'s predecessors must come from two different htmls.",
              index1 && index2);
          ...
          assertTrue(
              "getName(of second bridge) method must one predecessor.", name2Preds.size() == 1);
          ...
          assertTrue(
              "getName(of second bridge)'s predecessor must come from index2.html.",
              !index1 && index2);
          ...
          assertTrue(
              "getFirstName(of first bridge) method must have two predecessors.",
              first1Preds.size() == 2);
          ...
          assertTrue(
              "getFirstName(of first bridge)'s predecessor must come from two different htmls.",
              index1 && index2);
          ...
          assertTrue(
              "getFirstName(of second bridge) method must one predecessor.",
              first2Preds.size() == 1);
          ...
          assertTrue(
              "getFirstName(of second bridge)'s predecessor must come from index2.html.",
              !index1 && index2);
          ...
          assertTrue(
              "getLastName(of first bridge) method must have two predecessors.",
              last1Preds.size() == 2);
          ...
          assertTrue(
              "getLastName(of first bridge)'s predecessor must come from two different htmls.",
              index1 && index2);
          ...
          assertTrue(
              "getLastName(of second bridge) method must one predecessor.", last2Preds.size() == 1);
          ...
          assertTrue(
              "getLastName(of second bridge)'s predecessor must come from index2.html.",
              !index1 && index2);
      }
    }
  }
