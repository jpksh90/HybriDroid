...
public class BridgeFieldTest {
  ...
  @Test
  public void subWebViewBridgeInteraction()
      ...
      switch (testName) {
        case "BridgeFieldTest.apk":
              ...
              cg.getClassHierarchy()
                  .lookupClass(
                      TypeReference.find(
                          ...
                          "Lkr/ac/kaist/wala/hybridroid/bridgefieldaccess/JSBridge"));

          IMethod getName =
              cg.getClassHierarchy()
                  .resolveMethod(
                      MethodReference.findOrCreate(
                          bridgeC.getReference(), Selector.make("getInfo()Ljava/lang/String;")));

          CGNode getNameN = cg.getNode(getName, Everywhere.EVERYWHERE);

          int succNodes = cg.getSuccNodeCount(getNameN);
          assertTrue(
              "getInfo method must have 6 successors, but got " + succNodes + ".", succNodes == 6);
          ...
          while (iSucc.hasNext()) {
            ...
            if (succ.toString()
                .contains(
                    "Node: < Primordial, Ljava/lang/StringBuilder, <init>()V > Context: Everywhere"))
              isInit = true;
            if (succ.toString()
                .contains(
                    "Node: < Primordial, Ljava/lang/StringBuilder, toString()Ljava/lang/String; > Context: Everywhere"))
              isToString = true;
            else if (succ.toString()
                .contains(
                    "Node: < Primordial, Ljava/lang/StringBuilder, append(Ljava/lang/String;)Ljava/lang/StringBuilder; > Context: Everywhere"))
              isAppend = true;
            else if (succ.toString()
                .contains(
                    "Node: < Application, Lkr/ac/kaist/wala/hybridroid/bridgefieldaccess/DataHandler, getName()Ljava/lang/String; > Context: Everywhere"))
              isGetName = true;
            else if (succ.toString()
                .contains(
                    "Node: < Application, Lkr/ac/kaist/wala/hybridroid/bridgefieldaccess/DataHandler, getPhoneNumber()Ljava/lang/String; > Context: Everywhere"))
              isGetPhoneNumber = true;
            else if (succ.toString()
                .contains(
                    "Node: < Application, Lkr/ac/kaist/wala/hybridroid/bridgefieldaccess/MessageHandler, getMessage()Ljava/lang/String; > Context: Everywhere"))
              isGetMessage = true;
          }
