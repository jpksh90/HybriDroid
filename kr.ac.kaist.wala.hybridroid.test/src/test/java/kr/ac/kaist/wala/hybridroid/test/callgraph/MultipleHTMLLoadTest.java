...
//
//  @Test
//  public void loadSameJavaMethodFromDifferentHTMLPage()
...
//                          "Lkr/ac/kaist/wala/hybridroid/test/multiplepagetest/JSBridge"));
//
...
//            } else {
//              assertTrue(
//                  "index2's function must be getLastName.", n.toString().contains("getLastName"));
//            }
//          }
//
...
//                n.toString().contains("getName") && n.toString().contains("index1.html"));
//          }
//      }
//    }
//  }
