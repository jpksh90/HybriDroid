...
//                          "Lkr/ac/kaist/wala/hybridroid/subwebviewtest/JSBridge"));
//
//          IMethod getName =
//              cg.getClassHierarchy()
//                  .resolveMethod(
...
//                  isCalled = true;
//                  assertTrue(
//                      "getName method must be called by the instruction: 25 = dispatch 24@20 23 exception:26",
//                      invokeInst.toString().contains("25 = dispatch 24@20 23 exception:26"));
//                }
//              }
//            }
//          }
